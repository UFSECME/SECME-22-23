...
**A standard-size tennis ball with a diameter of 66.9 mm (0.64”) and 40 g will be given to the SECME student teams on the day of competition before their run at the SECME National Student Competition Finals.**
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME-22-23/Elementary_Guidelines_22-23/Calc Manual/WBR_CalcManual_PK-2.pdf")
```

**Grades 3-5**

```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME-22-23/Elementary_Guidelines_22-23/Calc Manual/WBR_CalcManual_3-5.pdf")
```
...
```
<center>
![](docs_MS/SECME Registration Information_MSHS.jpg){width=50%}
</center>
